...
<div class="content">
    <div class="box box-primary">
        <div class="box-body table-responsive">
			...
			<form class="form-inline ls-search" id="importForm" action="import.do" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label><s:message code="import"/></label>
                    <input class="form-control input-sm required" type="file" name="file"/>
                </div>
